...
./dist/openapi-gen \
  ...
  --input-dirs github.com/newrelic-forks/argo-cd/pkg/apis/application/${VERSION} \
  --output-package github.com/newrelic-forks/argo-cd/pkg/apis/application/${VERSION} \
