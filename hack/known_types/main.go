...
func newCommand() *cobra.Command {
	...
	var command = &cobra.Command{
		Use:     "go run github.com/newrelic-forks/argo-cd/hack/known_types ALIAS PACKAGE_PATH OUTPUT_PATH",
		Example: "go run github.com/newrelic-forks/argo-cd/hack/known_types corev1 k8s.io/api/core/v1 corev1_known_types.go",
	...
	knownTypes["%s/%s"] = func() interface{} {
		return &%s.%s{}
			...
			res := fmt.Sprintf(`// Code generated by github.com/newrelic-forks/argo-cd/hack/known_types. DO NOT EDIT.
package normalizers
